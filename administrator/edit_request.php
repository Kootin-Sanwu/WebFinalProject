    ...
    <form class="container-15" id="myModal" method="POST" action="../actions/edit_request_action.php">
        <div class="container-16">
            ...
            <div class="form-group">
                ...
                <input type="text" required name="project_name" id="edit_request_project_name" placeholder="New Project Name" required>

                <label for="begin_date">New Begin date:</label>
                <input type="date" required name="begin_date" id="edit_request_begin_date" placeholder="New Begin date" required>

                <label for="end_date">New End Date:</label>
                <input type="date" required name="end_date" id="edit_request_end_date" placeholder="New End Date" required>
            </div>
