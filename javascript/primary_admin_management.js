document.addEventListener('DOMContentLoaded', function () {
    ...
    var createButton = document.querySelector(".addchore-container button[name=addButton]");
    ...
    function resetStyles() {
        ...
        createButton.style.transform = 'translateY(0px)';
        createButton.style.backgroundColor = '#6f006d';
        createButton.style.boxShadow = '1px 1px rgb(65, 65, 65)';
    }
