document.addEventListener('DOMContentLoaded', function () {
    ...
    var assignButton = document.querySelector(".assignchore-container button[name=assignButton]");
    ...
    function resetStyles() {
        ...
        assignButton.style.transform = 'translateY(0px)';
        assignButton.style.backgroundColor = '#6f006d';
        assignButton.style.boxShadow = '1px 1px rgb(65, 65, 65)';
    }
    ...
    assignButton.addEventListener('mouseover', function () {
        submitHover(this);
    });

    assignButton.addEventListener('mouseout', function () {
        resetStyles();
    });

    assignButton.addEventListener('mousedown', function () {
        applyAddPressedEffect(this);
    });

    assignButton.addEventListener('mouseup', function () {
        submitHover(this);
    });
});
