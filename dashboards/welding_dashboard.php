...
<body>
    <div class="concept-container">
        <div class="container-two">
            ...
            <a href="../dashboards/welding_dashboard.php">
            ...
            <a href="../managements/welding_management.php">
                <div class="container-three">
            ...
            <a href="../allocations/welding_allocation.php">
                <div class="container-three">
            ...
            <a href="../requests/welding_request.php">
                <div class="container-three">
        ...
        <div class="container-one">
            ...
            <div class="inner-container-two">
                <div class="statistic-container">
                    <button name="allChoresButton">WELDING PROJECTS</button>
                </div>
                <div class="statistic-container">
