...
<body>
    <div class="concept-container">
        <div class="container-two">
            ...
            <a href="../dashboards/roofing_dashboard.php">
            ...
            <a href="../managements/roofing_management.php">
                <div class="container-three">
            ...
            <a href="../allocations/roofing_allocation.php">
                <div class="container-three">
            ...
            <a href="../requests/roofing_request.php">
                <div class="container-three">
        ...
        <div class="container-one">
            ...
            <div class="inner-container-two">
                <div class="statistic-container">
                    <button name="allChoresButton">ROOFING PROJECTS</button>
                </div>
                <div class="statistic-container">
